...
$\beta ,\alpha ,I_{CBO} (I_{CEO}) ,I_{CM} , U_{(BR)CEO} ,P_{CM} ,f_T$ 是它的主要参数.
...
$g_m,U_{GS(th)}或U_{GS(off)},I_{DSS},I_{DM},U_{(BR)DS},P_{DM}$和极间电容是它的主要参数.和晶体管类似,场效应管有夹断区,恒流区和可变电阻区三个工作区域.
